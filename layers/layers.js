...
var format_Bataswilayahrt_5 = new ol.format.GeoJSON();
var features_Bataswilayahrt_5 = format_Bataswilayahrt_5.readFeatures(json_Bataswilayahrt_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Bataswilayahrt_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Bataswilayahrt_5.addFeatures(features_Bataswilayahrt_5);
var lyr_Bataswilayahrt_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Bataswilayahrt_5, 
                style: style_Bataswilayahrt_5,
                popuplayertitle: "Batas wilayah rt",
                interactive: true,
    title: 'Batas wilayah rt<br />\
    <img src="styles/legend/Bataswilayahrt_5_0.png" /> RT 01 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_1.png" /> RT 01 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_2.png" /> RT 01 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_3.png" /> RT 01 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_4.png" /> RT 02 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_5.png" /> RT 02 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_6.png" /> RT 02 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_7.png" /> RT 02 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_8.png" /> RT 03 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_9.png" /> RT 03 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_10.png" /> RT 03 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_11.png" /> RT 03 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_12.png" /> RT 04 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_13.png" /> RT 04 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_14.png" /> RT 04 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_15.png" /> RT 04 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_16.png" /> RT 05 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_17.png" /> RT 05 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_18.png" /> RT 05 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_19.png" /> RT 05 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_20.png" /> RT 06 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_21.png" /> RT 06 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_22.png" /> RT 06 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_23.png" /> RT 06 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_24.png" /> RT 07 RW 01<br />\
    <img src="styles/legend/Bataswilayahrt_5_25.png" /> RT 07 RW 02<br />\
    <img src="styles/legend/Bataswilayahrt_5_26.png" /> RT 07 RW 03<br />\
    <img src="styles/legend/Bataswilayahrt_5_27.png" /> RT 07 RW 04<br />\
    <img src="styles/legend/Bataswilayahrt_5_28.png" /> <br />'
        });
...
var format_desaku_poly_7 = new ol.format.GeoJSON();
var features_desaku_poly_7 = format_desaku_poly_7.readFeatures(json_desaku_poly_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_desaku_poly_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_desaku_poly_7.addFeatures(features_desaku_poly_7);
var lyr_desaku_poly_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_desaku_poly_7, 
                style: style_desaku_poly_7,
                popuplayertitle: "desaku_poly",
                interactive: true,
                title: '<img src="styles/legend/desaku_poly_7.png" /> desaku_poly'
            });
var format_RumahKetuartrw_8 = new ol.format.GeoJSON();
var features_RumahKetuartrw_8 = format_RumahKetuartrw_8.readFeatures(json_RumahKetuartrw_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RumahKetuartrw_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RumahKetuartrw_8.addFeatures(features_RumahKetuartrw_8);
var lyr_RumahKetuartrw_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RumahKetuartrw_8, 
                style: style_RumahKetuartrw_8,
                popuplayertitle: "Rumah Ketua rt rw",
                interactive: true,
                title: '<img src="styles/legend/RumahKetuartrw_8.png" /> Rumah Ketua rt rw'
            });
var format_desaku_line_9 = new ol.format.GeoJSON();
var features_desaku_line_9 = format_desaku_line_9.readFeatures(json_desaku_line_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_desaku_line_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_desaku_line_9.addFeatures(features_desaku_line_9);
var lyr_desaku_line_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_desaku_line_9, 
                style: style_desaku_line_9,
                popuplayertitle: "desaku_line",
                interactive: true,
                title: '<img src="styles/legend/desaku_line_9.png" /> desaku_line'
            });
var format_saranapendidikan_10 = new ol.format.GeoJSON();
var features_saranapendidikan_10 = format_saranapendidikan_10.readFeatures(json_saranapendidikan_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_saranapendidikan_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_saranapendidikan_10.addFeatures(features_saranapendidikan_10);
var lyr_saranapendidikan_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_saranapendidikan_10, 
                style: style_saranapendidikan_10,
                popuplayertitle: "sarana pendidikan",
                interactive: true,
                title: '<img src="styles/legend/saranapendidikan_10.png" /> sarana pendidikan'
            });
...
var format_usahamasyarakat_12 = new ol.format.GeoJSON();
var features_usahamasyarakat_12 = format_usahamasyarakat_12.readFeatures(json_usahamasyarakat_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_usahamasyarakat_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_usahamasyarakat_12.addFeatures(features_usahamasyarakat_12);
var lyr_usahamasyarakat_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_usahamasyarakat_12, 
                style: style_usahamasyarakat_12,
                popuplayertitle: "usaha masyarakat",
                interactive: true,
                title: '<img src="styles/legend/usahamasyarakat_12.png" /> usaha masyarakat'
            });
var format_layananmasyarakat_13 = new ol.format.GeoJSON();
var features_layananmasyarakat_13 = format_layananmasyarakat_13.readFeatures(json_layananmasyarakat_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_layananmasyarakat_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_layananmasyarakat_13.addFeatures(features_layananmasyarakat_13);
var lyr_layananmasyarakat_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_layananmasyarakat_13, 
                style: style_layananmasyarakat_13,
                popuplayertitle: "layanan masyarakat",
                interactive: true,
                title: '<img src="styles/legend/layananmasyarakat_13.png" /> layanan masyarakat'
            });
...
var format_AGRISAWAH_AR_25K_16 = new ol.format.GeoJSON();
var features_AGRISAWAH_AR_25K_16 = format_AGRISAWAH_AR_25K_16.readFeatures(json_AGRISAWAH_AR_25K_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AGRISAWAH_AR_25K_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AGRISAWAH_AR_25K_16.addFeatures(features_AGRISAWAH_AR_25K_16);
var lyr_AGRISAWAH_AR_25K_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AGRISAWAH_AR_25K_16, 
                style: style_AGRISAWAH_AR_25K_16,
                popuplayertitle: "AGRISAWAH_AR_25K",
                interactive: true,
                title: '<img src="styles/legend/AGRISAWAH_AR_25K_16.png" /> AGRISAWAH_AR_25K'
            });
var format_baru_poly_17 = new ol.format.GeoJSON();
var features_baru_poly_17 = format_baru_poly_17.readFeatures(json_baru_poly_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_baru_poly_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_baru_poly_17.addFeatures(features_baru_poly_17);
var lyr_baru_poly_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_baru_poly_17, 
                style: style_baru_poly_17,
                popuplayertitle: "baru_poly",
                interactive: true,
                title: '<img src="styles/legend/baru_poly_17.png" /> baru_poly'
            });
var format_baru_line_18 = new ol.format.GeoJSON();
var features_baru_line_18 = format_baru_line_18.readFeatures(json_baru_line_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_baru_line_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_baru_line_18.addFeatures(features_baru_line_18);
var lyr_baru_line_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_baru_line_18, 
                style: style_baru_line_18,
                popuplayertitle: "baru_line",
                interactive: true,
                title: '<img src="styles/legend/baru_line_18.png" /> baru_line'
            });
...
var group_desarempoah = new ol.layer.Group({
                                layers: [lyr_ADMINISTRASIDESA_AR_25K_14,lyr_WilayahRTRW_15,lyr_AGRISAWAH_AR_25K_16,lyr_baru_poly_17,lyr_baru_line_18,lyr_UMKM_19,lyr_TempatIbadah_20,lyr_SUNGAI_LN_25K_21,lyr_RumahKetuaRT_22,lyr_Pendidikan_23,lyr_Pemerintahan_24,lyr_Kesehatan_25,],
                                fold: "open",
                                title: "desa rempoah"});
var group_desakebumen = new ol.layer.Group({
                                layers: [lyr_ADMINISTRASIDESA_AR_25K_2,lyr_AGRIKEBUN_AR_25K_3,lyr_AGRISAWAH_AR_25K_4,lyr_Bataswilayahrt_5,lyr_sungai_6,lyr_desaku_poly_7,lyr_RumahKetuartrw_8,lyr_desaku_line_9,lyr_saranapendidikan_10,lyr_saranaibadah_11,lyr_usahamasyarakat_12,lyr_layananmasyarakat_13,],
                                fold: "open",
                                title: "desa kebumen"});

lyr_OpenStreetMap_0.setVisible(true);lyr_gadm41_IDNADM_ADM_4_1.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_2.setVisible(true);lyr_AGRIKEBUN_AR_25K_3.setVisible(true);lyr_AGRISAWAH_AR_25K_4.setVisible(true);lyr_Bataswilayahrt_5.setVisible(true);lyr_sungai_6.setVisible(true);lyr_desaku_poly_7.setVisible(true);lyr_RumahKetuartrw_8.setVisible(true);lyr_desaku_line_9.setVisible(true);lyr_saranapendidikan_10.setVisible(true);lyr_saranaibadah_11.setVisible(true);lyr_usahamasyarakat_12.setVisible(true);lyr_layananmasyarakat_13.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_14.setVisible(true);lyr_WilayahRTRW_15.setVisible(true);lyr_AGRISAWAH_AR_25K_16.setVisible(true);lyr_baru_poly_17.setVisible(true);lyr_baru_line_18.setVisible(true);lyr_UMKM_19.setVisible(true);lyr_TempatIbadah_20.setVisible(true);lyr_SUNGAI_LN_25K_21.setVisible(true);lyr_RumahKetuaRT_22.setVisible(true);lyr_Pendidikan_23.setVisible(true);lyr_Pemerintahan_24.setVisible(true);lyr_Kesehatan_25.setVisible(true);
...
lyr_AGRISAWAH_AR_25K_16.set('fieldLabels', {'id': 'no label', 'NAMOBJ': 'no label', 'JNSSWH': 'no label', 'FCODE': 'no label', 'AQDATE': 'no label', 'PUDATE': 'no label', 'REMARK': 'no label', 'KODLCO': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'TNMSWH': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
lyr_baru_poly_17.set('fieldLabels', {'id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'layer': 'no label', 'tourism': 'no label', 'health_fac': 'no label', 'tunnel': 'no label', 'aeroway': 'no label', 'capacity': 'no label', 'parking': 'no label', 'staff_coun': 'no label', 'roof_mater': 'no label', 'addr_house': 'no label', 'width': 'no label', 'building': 'no label', 'isced_leve': 'no label', 'operator': 'no label', 'healthcare': 'no label', 'access_roo': 'no label', 'health_f_1': 'no label', 'beds': 'no label', 'shop': 'no label', 'staff_co_1': 'no label', 'building_m': 'no label', 'opening_ho': 'no label', 'smoothness': 'no label', 'railway': 'no label', 'toilets_di': 'no label', 'medical_sy': 'no label', 'name': 'no label', 'bridge': 'no label', 'operator_t': 'no label', 'rooms': 'no label', 'status': 'no label', 'network': 'no label', 'addr_stree': 'no label', 'toilets_ha': 'no label', 'amenity': 'no label', 'barrier': 'no label', 'health_f_2': 'no label', 'access': 'no label', 'highway': 'no label', 'surface': 'no label', 'oneway': 'no label', 'public_tra': 'no label', });
lyr_baru_line_18.set('fieldLabels', {'id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'layer': 'no label', 'smoothness': 'no label', 'railway': 'no label', 'tunnel': 'no label', 'aeroway': 'no label', 'capacity': 'no label', 'parking': 'no label', 'amenity': 'no label', 'width': 'no label', 'barrier': 'no label', 'name': 'no label', 'surface': 'no label', 'bridge': 'no label', 'highway': 'no label', 'building': 'no label', 'oneway': 'no label', 'operator': 'no label', 'public_tra': 'no label', });
